/* DES.C - Data Encryption Standard routines for RSAREF
...
static void Unpack (unsigned char *, UINT4 *);
static void Pack (UINT4 *, unsigned char *);
static void DESKey (UINT4 *, unsigned char *, int);
static void CookKey (UINT4 *, UINT4 *, int);
static void DESFunction (UINT4 *, UINT4 *);
