...
int qz_compress(char* dest, unsigned long* destlen, const char* src, unsigned long srclen);
int qz_uncompress(char* dest, unsigned long* destlen, const char* src, unsigned long srclen);
